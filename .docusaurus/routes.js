        ...
        routes: [
          {
            ...
            routes: [
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/plugins/advanced-discount-coupon-store-credit/installation-setup', 'ce7'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/plugins/wpdepositly/faq', '2f6'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
                path: '/docs/plugins/wpdepositly/features',
                component: ComponentCreator('/docs/plugins/wpdepositly/features', '106'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
                path: '/docs/plugins/wpdepositly/installation-setup',
                component: ComponentCreator('/docs/plugins/wpdepositly/installation-setup', '00b'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
                path: '/docs/plugins/wpdepositly/overview',
                component: ComponentCreator('/docs/plugins/wpdepositly/overview', '3e3'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
                path: '/docs/plugins/wpdepositly/settings',
                component: ComponentCreator('/docs/plugins/wpdepositly/settings', 'd88'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
                path: '/docs/plugins/wpdepositly/shortcodes',
                component: ComponentCreator('/docs/plugins/wpdepositly/shortcodes', 'f78'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
