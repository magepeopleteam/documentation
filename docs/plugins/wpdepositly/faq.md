...
You can offer percentage-based deposits, fixed amount deposits, or require full payment.
...
Yes. The full payment option can be enabled to give customers a choice.

## Can I set different deposit rules per product?

Yes. Deposit rules can be configured globally or per product.
