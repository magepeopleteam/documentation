---
title: Overview
description: Car Rental Manager plugin for WordPress overview.
sidebar_position: 1
---

# Car Rental

Car Rental Manager is a comprehensive car rental plugin for WordPress that allows you to manage vehicles, drivers, bookings, and pricing seamlessly.
...
- Configure labels, slug, and basic preferences
...
Customize the plugin, translate labels, manage FAQ, and configure global settings for your car rental website.

- Change the plugin label and slug in settings
- Translate the plugin using Loco Translate or WPML
- Customize booking form colors and styles
- Manage rental bookings from the dashboard
- Configure customer notifications via SMS and email
