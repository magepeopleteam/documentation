...
1. Copy the default template folder from `templates/single/default/`.
2. Rename the copied folder to your preferred template name (e.g., `modern`, `custom-layout`).
3. Create a preview image with the same name (e.g., `modern.webp`) and place it inside `templates/screenshot/`.
