---
title: Overview
description: eCab — Taxi Booking Plugin for WordPress overview.
sidebar_position: 1
---

# eCab

eCab is a comprehensive taxi booking plugin for WordPress that allows you to manage cabs, drivers, and ride bookings seamlessly.
...
- Configure global currency and timezone settings
...
Learn about price-based models, location management, initial pricing, off-day settings, and translation support for the eCab plugin.

- Price-based models overview
- Initial price in transport
- Distance-based pricing (per km + per hour)
