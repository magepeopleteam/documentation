---
title: Overview
description: WpBusTicketly — Bus Ticket Booking with Seat Reservation plugin overview.
sidebar_position: 1
---

# WpBusTicketly

WpBusTicketly is a comprehensive bus ticket booking plugin for WordPress that allows you to manage bus routes, schedules, seat reservations, and bookings seamlessly.
...
Learn how to add buses, manage routes, set up pricing, handle taxes, and configure passenger management features.

- Instructions to start a bus booking
- Add a bus to the list from dashboard
- Setup bus types (AC / Non-AC)
- Create bus stops and boarding points
- How to add VAT and tax
- Purchase a ticket from dashboard (PRO)
- Export passenger list (PRO)
